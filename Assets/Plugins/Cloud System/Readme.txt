Cloud System
We recommend you to have a look at the example scenes, if you are using the Cloud System for the first time. They are bundled in the "Plugins/Cloud System/Demos/CloudSystemDemos.unitypackage".
Further there is a step by step explanation about how to create a new cloud in "Plugins/Cloud System/Documentation/Getting Started.pdf". A detailed "Reference.pdf" is also in that folder.
